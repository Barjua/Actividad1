...
// Soporte: Firefox 18+
// No puede estar en modo estricto, varias libs, incluido el rastro de ASP.NET
...
jQuery.extend ({
	...
	isNumeric: function (obj) {
		...
		// agregando 1 corrige la pérdida de precisión de parseFloat (# 15100)
	...
	globalEval: function (data) {
		if (data && jQuery.trim (data)) {
			...
			(window.execScript || función (datos) {
				ventana ["eval"] .call (ventana, datos); // jscs: ignore requireDotNotation
			}) (datos);
		}
	},
